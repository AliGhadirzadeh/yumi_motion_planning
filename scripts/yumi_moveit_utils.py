...
# Credits
# Guomundur F. Hallgrimsson (gudhal@kth.se) and Junxun Luo (junxun@kth.se) heavily contributed to the
# development of the Python scripts presented, as part of their work at KTH-RPL
...
def init_Moveit(planning_frame="/yumi_body"):
